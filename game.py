...
# Run this for requirements 'pip3 install -r requirements.txt' (Select the appropriate requirements file for your platform)
# Run to make flow chart 'pyreverse -o svg  -p  *.py .'
